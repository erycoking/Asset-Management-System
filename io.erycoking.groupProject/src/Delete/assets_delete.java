...
public class assets_delete extends Application {
    ...
    public void start(final Stage primaryStage) {
        primaryStage.setTitle("asset deletion records");
        ...
        TableColumn col_id = new TableColumn("Equipment ID");
        tableView.getColumns().add(col_id);
        col_id.setCellValueFactory(
                    new PropertyValueFactory<Record, String>("Equipment id"));
